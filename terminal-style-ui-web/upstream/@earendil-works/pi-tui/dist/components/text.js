...
// fork 统一块渲染引擎(源:god.frontend.tui/ui_elements/blocks_nongod.js,install.sh 部署到 pi-tui/dist/)
...
export class Text {
    ...
    render(width) {
        ...
        // fork: 折行走统一引擎的挂起缩进 —— 行首是 "• "/"◦ " 这类 bullet 时，续行对齐到内容列；
        ...
        for (const line of wrappedLines) {
            ...
            if (this.customBgFn) {
                ...
                if (paddingNeeded <= 0) {
                    ...
                    // fork: 行尾 ANSI/OSC 不可见序列要留在补位空格之后（超链接下划线伪影修复）

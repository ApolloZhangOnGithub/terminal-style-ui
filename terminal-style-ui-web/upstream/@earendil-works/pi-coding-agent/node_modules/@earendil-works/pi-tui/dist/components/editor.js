...
// 2026-09-17（反馈：38;5 残渣 = 粘贴彩色文本泄漏可打印尾巴）：整段剥掉完整 ANSI/CSI/OSC 序列。
...
export class Editor {
    ...
    handleInput(data) {
        ...
        if (data.charCodeAt(0) >= 32) {
            // 2026-09-17（反馈：38;5 残渣）：非 bracketed-paste 的终端会把整块（含内嵌 ANSI）直接送来——
    ...
    handlePaste(pastedText) {
        ...
        // 2026-09-17（反馈：38;5 残渣）：先整段剥 ANSI（模块级 stripAnsiComplete），再归一化。
